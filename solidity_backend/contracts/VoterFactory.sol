...
contract VoterFactory{
    ...
    function createVoter(uint256 aadhaar, uint8 day, uint8 month, uint16 year, string memory name, int ward, string memory mobile) public restrictedAdminContract returns (address){
        ...
        Voter newVoter = new Voter(aadhaar, day, month, year, name, ward, mobile, candidateFactory, address(this), ballotAddress);
